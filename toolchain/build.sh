...
echo
cd binutils-2.23.1
patch -p1 < ../patches/binutils-2.23.1-TextOS.patch #|| err
cd ..
cd build-binutils
...
echo
cd gdb-7.6.2
patch -p1 < ../patches/gdb-7.6.2-TextOS.patch #|| err
cd ..
...
echo
cd newlib-1.20.0
patch -p1 < ../patches/newlib-1.20.0-TextOS.patch #|| err
mkdir -p newlib/libc/sys/TextOS
cp -Rf ../patches/TextOS/* newlib/libc/sys/TextOS/ || err
...
echo
echo Successfully build and installed TextOS toolchain to $PREFIX'!'
echo
